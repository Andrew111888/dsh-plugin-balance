...
// 边缘迟滞：徽章展开会让胶囊变宽、锚点微调位置，指针可能恰好落在边缘外几个像素，
// 这种"离开"不算离开（否则 enter/leave 反复触发导致抽搐）。
if (pointerNearElement(e, boxRef.current, 14)) return;
clearUsageTimers();
setUsageHover(false);
}
/* 指针是否在元素矩形外扩 margin 的范围内 */
function pointerNearElement(e, el, margin) {
