...
h("div", { style: Object.assign({}, smallTextStyle(T.text3), { marginTop: 5 }) }, "近 7 天趋势")
));
...
var modelSectionTitle = "按模型统计 · " + (tokenTab === "day" ? "今日" : tokenTab === "week" ? "近7天" : "本月");
if (periodModels.length > 0) {
var modelRows = periodModels.map(function (entry, index) {
var m = entry.m;
var agg = entry.a;
...
h("div", { style: { padding: "6px 12px 4px", fontSize: 11, lineHeight: "15px", fontWeight: 600, color: T.text3, letterSpacing: ".06em", borderTop: "1px solid color-mix(in srgb, " + T.border + " 70%, transparent)" } }, modelSectionTitle),
modelRows
));
} else {
tokenPanelChildren.push(h("div", { key: "no-models", style: { padding: "6px 12px 8px", color: T.text3, fontSize: 12, lineHeight: "18px", borderTop: "1px solid color-mix(in srgb, " + T.border + " 70%, transparent)" } },
tokenTab === "day" ? "今日还没有模型消耗。" : tokenTab === "week" ? "近 7 天还没有模型消耗。" : "本月还没有模型消耗。"));
}
