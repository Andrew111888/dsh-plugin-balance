...
".dsh-balance-panel{animation:dsh-balance-panel .3s cubic-bezier(.19,.9,.28,1) both;animation-delay:.12s}",
...
// 欠阻尼弹簧：ω≈7.07，ζ≈0.85 → 收敛 ~0.7s，轻微过冲
var k = 50, c = 12, m = 1;
...
return h("div", {
ref: boxRef,
className: "dsh-balance-root" + (closing ? " dsh-balance-out" : ""),
